%% MAINSCRIPT RISE-based modular adaptive controller with update law thetahatdot=0;
clc; clear; close all;

global Ks alpha1 alpha2 beta E0 


%%%%%%%%%%%%%%%%%%%Tunable Controller Parameters%%%%%%%%%%%%%%%%%%%%%%%%%%%
Ks=9; %Constant in mu
beta=10;%Constant multiplying sgn(E) in the expression for nudot
...
[time,X_Sol]=ode113(@ode_RISEmodular1,tspan,X0,options);
